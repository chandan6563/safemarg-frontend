      ...
      <div className="max-w-6xl mx-auto px-6 py-10 lg:py-16">
        ...
        <div className="text-center space-y-3 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Your insights are the compass that guides our innovation. Tell us
            about your journey so we can build a better travel experience for
            everyone.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="bg-white rounded-[2.5rem] p-6 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100">
              <h3 className="text-2xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                <ThumbsUp className="w-6 h-6 text-blue-600" /> Rate Your
                Experience
              </h3>
                ...
                {emojis.map((emoji, idx) => (
                  <button
                    ...
                    className={`flex flex-col items-center gap-3 transition-all duration-300 transform ${
                      (hoverRating || rating) === idx + 1
                        ? "scale-125"
                        : "scale-100 opacity-40 grayscale-[50%]"
                    }`}
                  >
                    <span className="text-4xl md:text-5xl cursor-pointer">
                      {emoji.symbol}
                    </span>
                    <span
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-blue-400 outline-none transition-all font-medium shadow-inner"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-gray-950 text-white rounded-[2.5rem] p-10 overflow-hidden relative group">
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                We don&apos;t just collect feedback; we act on it. Every week,
                our product team reviews submissions to prioritize features that
                matter most to you.
              </p>
              <div className="space-y-4">
                {[
                  {
                    icon: ShieldCheck,
                    text: "Anonymous unless you share email",
                  },
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                {
                  title: "Usability",
                  desc: "Is the site easy to navigate?",
                  icon: Sparkles,
                },
                {
                  title: "Booking",
                  desc: "Any issues during checkout?",
                  icon: MessageSquare,
                },
                {
                  title: "Support",
                  desc: "How was your chat experience?",
                  icon: Star,
                },
              ].map((cat, i) => (
                <div
                  key={i}
                  className="bg-white p-6 rounded-3xl border border-gray-100 flex items-center gap-5 hover:border-blue-200 transition-colors shadow-sm"
                >
        ...
        <div className="mt-12 text-center pb-12">
          <p className="text-gray-400 text-sm font-medium italic">
            {" "}
            &quot;Fly Smart. Travel Safe. Improve Together.&quot;
          </p>
        </div>
      </div>
    </div>
