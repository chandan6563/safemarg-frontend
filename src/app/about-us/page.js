      ...
      <section className="relative h-[35vh] lg:h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl">
          ...
          <p className="text-sm md:text-lg font-medium max-w-2xl mx-auto opacity-90 drop-shadow-lg animate-in fade-in slide-in-from-bottom-10 duration-1000">
            SafeMarg is redefining the travel experience with seamless, secure,
            and smart solutions.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-16 lg:space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-2xl md:text-4xl font-black text-gray-900 leading-tight">
              Your Trusted IATA-Accredited Travel Partner
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed italic border-l-4 border-blue-500 pl-6 py-2">
              SafeMarg is a modern, customer-focused travel agency built to make
              travel easy and accessible.
            </p>
            <p className="text-base text-gray-600 leading-relaxed">
              Whether you&apos;re flying for business, vacationing with family,
              or booking a last-minute trip, our platform offers the best deals
              on flights, hotels, and cab services, all in one place.
            </p>
          </div>
        ...
        <div className="space-y-10">
          <div className="text-center space-y-3">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-base leading-relaxed">
              Everything you need for a perfect trip, managed with expert care.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Real-time comparisons for cheap domestic/international tickets.",
                icon: Plane,
                color: "text-blue-500",
                bg: "bg-blue-50",
              },
              {
                ...
                desc: "Handpicked budget to luxury stays in top destinations.",
                icon: Hotel,
              ...
              {
                title: "Cab Services",
                desc: "Reliable airport transfers/local cabs for your schedule.",
                icon: Car,
              ...
              },
              {
                ...
                desc: "Dedicated experts available 24/7 to assist you.",
                icon: Headset,
              ...
              >
                <div className="h-full p-6 lg:p-8 rounded-[2rem] bg-white border border-gray-100 shadow-[0_5px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] transition-all group flex flex-col items-center text-center">
                  <div
                    className={`p-4 rounded-2xl ${service.bg} mb-6 group-hover:rotate-6 transition-transform duration-500 ${service.color}`}
                  >
                ...
                {[
                  {
                    ...
                    icon: ShieldCheck,
                    desc: "Globally recognized security standard.",
                  },
                  {
                    title: "Best Price Guarantee",
                    icon: BadgeDollarSign,
                    desc: "Premium travel at affordable rates.",
                  },
                  {
                    title: "Secure Infrastructure",
                    icon: Lock,
                    desc: "Advanced encryption for every transaction.",
                  },
                ].map((item, idx) => (
              ...
              <div className="relative group perspective">
                ...
                <div className="relative bg-white/5 backdrop-blur-xl rounded-[2.5rem] p-10 border border-white/10 shadow-2xl text-center space-y-6 transform hover:scale-[1.02] transition-transform duration-500">
                  ...
                  <p className="text-base opacity-80 leading-relaxed italic font-light">
                    &quot;Empowering every traveler with smarter choices and
        ...
        <div className="relative max-w-5xl mx-auto rounded-[2.5rem] bg-gradient-to-br from-blue-50 to-indigo-50 p-10 md:p-14 text-center space-y-8 border border-white shadow-xl overflow-hidden group">
          ...
          <div className="relative z-10 space-y-4">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-base leading-relaxed">
              Our travel specialists are waiting to help you navigate your
              journey with expert advice and support.
            </p>
          </div>
          ...
          <div className="relative z-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white px-8 py-4 rounded-xl shadow-sm hover:shadow-xl transition-all text-blue-600 font-bold border border-blue-100 hover:border-blue-400 text-sm"
            >
              <Mail className="w-4 h-4" /> support@safemarg.com
            </a>
            <a
              href="tel:+919650070205"
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 px-8 py-4 rounded-xl shadow-xl hover:shadow-blue-600/40 hover:-translate-y-1 transition-all text-white font-bold text-sm"
            >
          ...
          <div className="pt-8">
            <p className="text-xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 bg-clip-text text-transparent inline-flex items-center gap-3">
              Fly Smart. Travel Safe. With SafeMarg.{" "}
              <Plane className="text-blue-600/80 w-6 h-6 border-b-2 border-blue-400" />
            </p>
          </div>
        </div>
      </div>
