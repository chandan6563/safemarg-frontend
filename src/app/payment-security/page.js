    ...
    >
      <section className="mb-12 text-center md:text-left">
        <p className="text-xl text-gray-700 leading-relaxed font-medium">
          At <strong className="text-blue-600">SafeMarg</strong>, the security of your payment information is our absolute priority. 
          We use enterprise-grade protocols to ensure every transaction is shielded from unauthorized access.
        </p>
      </section>
      ...
      <div className="space-y-20">
        <section id="gateway" className="scroll-mt-24">
          ...
          <p className="leading-relaxed mb-6">
            All payments are processed via trusted third-party gateways. We <strong className="text-red-500">never store</strong> your full credit/debit card information on our servers. 
            Data is tokenized and encrypted during the entire transmission process.
          </p>
        ...
        <section id="encryption" className="scroll-mt-24">
          ...
          <div className="p-8 rounded-3xl bg-gray-950 text-white relative overflow-hidden">
             ...
             <p className="text-lg opacity-80 leading-relaxed italic border-l-2 border-blue-400 pl-6">
               SafeMarg uses industry-standard 256-bit SSL (Secure Socket Layer) technology. This ensures all data between your browser 
               and our servers remains private, providing a "bulletproof" layer for your financial interactions.
             </p>
          </div>
        </section>
        ...
        <section id="compliance" className="scroll-mt-24">
          ...
          <p className="leading-relaxed">
            We adhere to <strong>PCI-DSS (Payment Card Industry Data Security Standard)</strong>. 
            This global standard dictates how cardholder data is managed to prevent fraud and unauthorized breaches. 
            Our partners undergo regular security audits to maintain this rigid certification.
          </p>
        </section>
        ...
        <section id="fraud" className="scroll-mt-24">
          ...
          <p className="leading-relaxed">
            Our infrastructure includes automated monitoring systems that detect anomalous and suspicious behaviors 24/7. 
            If a risk is flagged, our security team may contact you to verify identity before a transaction completes.
          </p>
        </section>
        ...
        <section id="responsibility" className="scroll-mt-24 pb-12">
          ...
          <div className="space-y-4">
             {[
               ...
               <div key={i} className="flex items-center gap-4 p-4 rounded-xl border border-amber-100 bg-amber-50/30 text-amber-900 font-medium italic">
